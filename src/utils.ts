...
export function replyHttp(code: number, message: any, res: http.ServerResponse, data: Record<string, any> | null = null, headers: Record<string, any> = {}) {
...
export const catchAsync = (fn: (...args: any[]) => any) => (req: http.IncomingMessage, res: http.ServerResponse) => {
